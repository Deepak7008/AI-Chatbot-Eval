...
if is_access_unlocked():
    ...
    # Show disabled text input that looks similar to chat input
    st.text_input(
        "🔒 Enter password in Setup page to chat",
        value="",
        key="locked_chat_placeholder",
        disabled=True,
        help="Enter password in Setup page to unlock chat functionality"
    )
